...
class Maze:
    ...
    def _solve_r(self, i, j):
        ...
        self._animate(delay=0.05)

        # Mark cell visited
        self._cells[i][j].visited = True

        # Check if I am at the end of the maze
